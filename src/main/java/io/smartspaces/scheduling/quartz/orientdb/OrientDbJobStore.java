...
public class OrientDbJobStore implements JobStore {
	...
	public OperableTrigger retrieveTrigger(final TriggerKey triggerKey) throws JobPersistenceException {
		return assembler.getOrientDbConnector().doInTransaction(new TransactionMethod<OperableTrigger>() {
			@Override
	...
	public Set<TriggerKey> getTriggerKeys(final GroupMatcher<TriggerKey> matcher) throws JobPersistenceException {
		return assembler.getOrientDbConnector().doInTransaction(new TransactionMethod<Set<TriggerKey>>() {
			@Override
	...
	public Collection<String> pauseTriggers(final GroupMatcher<TriggerKey> matcher) throws JobPersistenceException {
		return assembler.getOrientDbConnector().doInTransaction(new TransactionMethod<Collection<String>>() {
			@Override
	...
	public List<OperableTrigger> acquireNextTriggers(final long noLaterThan, final int maxCount, final long timeWindow)
			throws JobPersistenceException {
		return assembler.getOrientDbConnector().doInTransaction(new TransactionMethod<List<OperableTrigger>>() {
			@Override
	...
	public List<TriggerFiredResult> triggersFired(final List<OperableTrigger> triggers) throws JobPersistenceException {
		return assembler.getOrientDbConnector().doInTransaction(new TransactionMethod<List<TriggerFiredResult>>() {
			@Override
