...
public class MongoConnector {
    ...
    public static class MongoConnectorBuilder {
        ...
        public MongoConnectorBuilder withUri(String orientdbUri) {
        ...
        private MongoClient connectToMongoDB(final String orientdbUriAsString) throws SchedulerConfigException {
            try {
                return new MongoClient(new MongoClientURI(orientdbUriAsString));
